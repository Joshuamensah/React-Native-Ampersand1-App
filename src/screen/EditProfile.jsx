...
import { View, StyleSheet, Text, TouchableOpacity, TextInput, KeyboardAvoidingView, SafeAreaView, ScrollView, ImageBackground } from 'react-native'
                ...
                <ScrollView style={styles.Container}>
                    ...
                    source={{ uri: image }} style={styles.UserContainer}>
                        <TouchableOpacity
                            ...
                            <Text style={styles.ProfileText}>EDIT PROFILE PHOTO</Text>
                        </TouchableOpacity>
                    </ImageBackground>
